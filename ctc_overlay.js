								 ...
								 ctcOverlayViewer.removeClass(['overlayContentloadingV'],closeBtn);
									...
									if(totalImageCount>=2){
									 ...
									 if(activeGallerySpan[0] !== undefined){
										...
										let style = [['opacity','0'],["background-image",'url('+imageToLoad+')'],['height',Math.round(optimizedImageHeight)],['width',Math.round(optimizedImageWidth)],['margin-left',containerMarginLeft+"px"],["margin-top",containerMarginTop+"px"]];
